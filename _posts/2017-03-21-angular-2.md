...
[Part 1 - Installation]({{ site.url }}/2017-03-14-a-look-into-the-latest-javascript-frameworks-installation)
...
Event Listing
<img src="{{ site.url }}/assets/{{ post.date }}/EventListingView.PNG" alt="Event Listing View" style="width: 600px;"/>
...
Event Detail
<img src="{{ site.url }}/assets/{{ post.date }}/EventDetailView.PNG" alt="Event Listing View" style="width: 600px;"/>
...
<ul class="events">
    <li *ngFor="let hostEvent of hostEvents" 
        ...
        <span class="badge">{{hostEvent.date}}</span> {{hostEvent.name}} <span class="price">{{ hostEvent.price | priceFilter }}</span>
    </li>
</ul>
